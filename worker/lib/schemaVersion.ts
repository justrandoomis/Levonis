 ...
 */
export const EXPECTED_MIGRATION = '0107_support_message_media.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 105 files and the newest is 0107 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 105;
