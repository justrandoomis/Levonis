 ...
 */
export const EXPECTED_MIGRATION = '0099_product_media_dimensions.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 96 files and the newest is 0098 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 97;
