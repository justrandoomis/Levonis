 ...
 */
export const EXPECTED_MIGRATION = '0094_order_delivery_day.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 92 files and the newest is 0094 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 92;
