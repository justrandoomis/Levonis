 ...
 */
export const EXPECTED_MIGRATION = '0106_withdrawal_declared_iqd.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 104 files and the newest is 0106 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 104;
