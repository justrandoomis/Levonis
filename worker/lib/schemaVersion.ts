 ...
 */
export const EXPECTED_MIGRATION = '0123_store_app_icons.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 118 files and the newest is 0123 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 118;
