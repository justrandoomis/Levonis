 ...
 */
export const EXPECTED_MIGRATION = '0104_product_gini_url.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 102 files and the newest is 0104 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 102;
