 ...
 */
export const EXPECTED_MIGRATION = '0093_price_reports.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 91 files and the newest is 0093 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 91;
