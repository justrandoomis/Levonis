 ...
 */
export const EXPECTED_MIGRATION = '0105_deposit_declared_iqd.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 103 files and the newest is 0105 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 103;
