 ...
 */
export const EXPECTED_MIGRATION = '0092_stock_alerts.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 90 files and the newest is 0092 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 90;
