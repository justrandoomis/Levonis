 ...
 */
export const EXPECTED_MIGRATION = '0127_catalog_backfill.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 124 files and the newest is 0127 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 124;
