 ...
 */
export const EXPECTED_MIGRATION = '0108_wallet_ledger_dinars.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 106 files and the newest is 0108 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 106;
