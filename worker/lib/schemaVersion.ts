 ...
 */
export const EXPECTED_MIGRATION = '0135_category_delivery_rules.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 129 files and the newest is 0135 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 129;
