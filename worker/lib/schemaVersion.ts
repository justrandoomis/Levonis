 ...
 */
export const EXPECTED_MIGRATION = '0090_signup_tickets_blocked_terms.sql';
 ...
 * name above.
 *
 * IT IS NOT THE HIGHEST NUMBER. There are 85 files and the newest is 0087 —
 ...
 */
export const EXPECTED_MIGRATION_COUNT = 88;
