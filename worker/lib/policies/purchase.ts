...
تبيّن هذه الوثيقة شروط الشراء من ليفونيس: من يحق له الشراء، وكيف يتكوّن الطلب، ومتى يصبح ملزماً للطرفين، وماذا يشمل السعر المعروض، وما هي واجبات الزبون عند التسليم. وهي وثيقة تعاقدية تُقرأ مع باقي وثائق المتجر ولا تحلّ محلها.
...
### 1.3 التعريفات
- المتجر أو ليفونيس: المتجر الرسمي الذي يبيع بضاعته الخاصة ويشحنها من مخزنه.
- مجتمع ليفو: المساحة التي يعرض فيها التجار المستقلون بضاعتهم داخل المنصة.
- التاجر: بائع مستقل يملك متجراً داخل مجتمع ليفو، وهو البائع في طلباته لا ليفونيس.
...
### 1.4 نطاق التطبيق
تسري هذه السياسة على كل طلب يُنشأ عبر المنصة، سواء كان بائعه ليفونيس أو تاجراً في مجتمع ليفو، وعلى كل وسيلة دفع وكل وسيلة تسليم، ما لم يُنصّ على خلاف ذلك في بند صريح.
...
لا تجمع السلة الواحدة بين بضاعة ليفونيس وبضاعة تاجر، ولا بين تاجرين. وعند محاولة الجمع يرفض النظام الإضافة حتى تُفرَغ السلة، لأن كل بائع مسؤول عن طلبه ووسيلة تسليمه وعمولته على حدة.
...
أجرة التوصيل والضريبة المرتبطة بها تحددهما شركات التوصيل، لا ليفونيس. المتجر ينقل إلى الزبون ما تفرضه الشركة الناقلة ولا يضيف إليه ولا يتحكم به، وأي تغيير في تعرفة الشركة ينعكس على ما يُعرض عند الطلب.
...
ئەم بەڵگەنامەیە مەرجەکانی کڕین لە لیڤۆنیس دیاری دەکات: کێ بۆی هەیە بکڕێت، داواکاری چۆن پێک دێت، کەی بۆ هەردوو لا بەندکەر دەبێت، نرخی پیشاندراو چی لەخۆ دەگرێت، و کڕیار لە کاتی وەرگرتندا چی لەسەرە. بەڵگەنامەیەکی گرێبەستییە و لەگەڵ سیاسەتەکانی دیکەی فرۆشگا دەخوێنرێتەوە، نەک لە جێگەی ئەوان.
...
### 1.3 پێناسەکان
- فرۆشگا یان لیڤۆنیس: فرۆشگا فەرمییەکە کە کاڵای خۆی دەفرۆشێت و لە کۆگای خۆیەوە دەینێرێت.
- کۆمەڵگای لیڤۆ: ئەو بۆشاییەی بازرگانە سەربەخۆکان کاڵای خۆیانی تێدا پیشان دەدەن لە ناو پلاتفۆرمەکە.
- بازرگان: فرۆشیارێکی سەربەخۆ کە فرۆشگایەکی هەیە لە ناو کۆمەڵگای لیڤۆ، و لە داواکارییەکانی خۆیدا ئەو فرۆشیارە نەک لیڤۆنیس.
...
ئەم سیاسەتە بۆ هەموو داواکارییەک جێبەجێ دەبێت کە لە ڕێگەی پلاتفۆرمەوە دروست دەبێت، جا فرۆشیارەکەی لیڤۆنیس بێت یان بازرگانێک لە کۆمەڵگای لیڤۆ، و بۆ هەموو شێوازێکی پارەدان و گەیاندن، مەگەر بڕگەیەکی ڕوون پێچەوانەی بڵێت.
...
یەک سەبەتە کاڵای لیڤۆنیس و کاڵای بازرگانێک کۆناکاتەوە، نە دوو بازرگانیش. لە کاتی هەوڵدان بۆ تێکەڵکردن، سیستەم زیادکردنەکە ڕەت دەکاتەوە هەتا سەبەتەکە بەتاڵ دەکرێت، چونکە هەر فرۆشیارێک بە جیا بەرپرسیارە لە داواکاری و گەیاندن و کۆمیسیۆنی خۆی.
...
کرێی گەیاندن و ئەو باجەی پێوەی بەستراوە لەلایەن کۆمپانیاکانی گەیاندنەوە دیاری دەکرێن، نەک لەلایەن لیڤۆنیسەوە. فرۆشگا ئەوە دەگوازێتەوە بۆ کڕیار کە کۆمپانیای گواستنەوە داوای دەکات، هیچی بۆ زیاد ناکات و کۆنترۆڵی ناکات، و هەر گۆڕانێک لە تەعریفەی کۆمپانیاکە ڕەنگدانەوەی دەبێت لەوەی لە کاتی داواکاریدا پیشان دەدرێت.
