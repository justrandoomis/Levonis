...
هذه الوثيقة تبيّن تمديد الضمان المدفوع الذي يبيعه ليفونيس على الطابعات، وشرط شرائه، وما يغيّره وما لا يغيّره. تُقرأ مع وثيقة الضمان، المادة 5، ولا تُقرأ وحدها. النص العربي هو النص المعتمد.
...
- الأجهزة التي لم تُشترَ من ليفونيس، وأجهزة التجار المستقلين داخل ليفو برو.
...
ئەم بەڵگەنامەیە ئەو درێژکردنەوە پارەدراوەی گەرەنتی ڕوون دەکاتەوە کە لێڤۆنیس لەسەر پرینتەرەکان دەیفرۆشێت، مەرجی کڕینی، و ئەوەی دەیگۆڕێت و ئەوەی ناگۆڕێت. لەگەڵ بەڵگەنامەی گەرەنتی، ماددەی 5، دەخوێندرێتەوە و هەرگیز بە تەنها نا. دەقی عەرەبی دەقی پەسەندکراوە.
...
- ئەو ئامێرانەی لە لێڤۆنیس نەکڕدراون، و ئامێرەکانی بازرگانە سەربەخۆکان لەناو لێڤۆ پرۆ.
