 ...
 *   * THE UNKNOWNS. 1 article and 9 further lines in this document still state a
...
هذه الوثيقة تبيّن ضمان القطع الذي يمنحه متجر Levonis على الأجهزة التي يبيعها، وحدودَه وإجراءاته. النص العربي هو النص المعتمد، وما سواه ترجمة أمينة له بالترقيم نفسه. تقديم أي مطالبة ضمان يعني الاطلاع على هذه الوثيقة وقبول ما فيها.

### 5.1 التعريفات
- المتجر: {{LEVONIS_LEGAL_NAME}}، المشار إليه في هذه الوثيقة بـ Levonis.
- الزبون: الشخص الذي اشترى الجهاز من Levonis، أو الحساب الذي يحمل تسجيل الجهاز.
...
- الأجهزة التي لم تُشترَ من Levonis، والأجهزة التي اشتُريت من تاجر مستقل داخل منصة ليفو برو والتي يتحمل ضمانها بائعها المعلن.
...
ضمان Levonis ضمان بائع مستقل عن ضمان المصنّع، ولا يعني اعتمادًا من العلامة التجارية ولا وكالةً عنها. لا يُلزم هذا الضمان المصنّع بشيء، ولا يلزم المتجرَ بما يعد به المصنّع. وحيث تكون سياسة المصنّع أوسع في حالة بعينها، يعين المتجر الزبونَ على الوصول إليها دون أن يضمن نتيجتها.
...
ئەم بەڵگەنامەیە گەرەنتی پارچەکان ڕوون دەکاتەوە کە فرۆشگای Levonis لەسەر ئەو ئامێرانە دەیدات کە دەیفرۆشێت، لەگەڵ سنوورەکانی و ڕێکارەکانی. دەقی عەرەبی دەقی پەسەندکراوە و ئەمە وەرگێڕانێکی دڵسۆزی ئەوە بە هەمان ژمارەبەندی. پێشکەشکردنی هەر داواکارییەکی گەرەنتی واتای خوێندنەوە و پەسەندکردنی ئەم بەڵگەنامەیە.

### 5.1 پێناسەکان
- فرۆشگا: {{LEVONIS_LEGAL_NAME}}، کە لەم بەڵگەنامەیەدا بە Levonis ئاماژەی پێدەکرێت.
- کڕیار: ئەو کەسەی ئامێرەکەی لە Levonis کڕیوە، یان ئەو هەژمارەی تۆمارکردنی ئامێرەکەی پێیە.
...
- ئەو ئامێرانەی لە Levonis نەکڕدراون، و ئەو ئامێرانەی لە بازرگانێکی سەربەخۆی ناو پلاتفۆرمی لێڤۆ پرۆ کڕدراون کە گەرەنتییەکەیان لەسەر ئەو فرۆشیارەیە کە ناوی هاتووە.
