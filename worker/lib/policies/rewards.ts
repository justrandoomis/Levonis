...
تبيّن هذه الوثيقة كيف تُكتسب نقاط ليفونيس وبأي معدل، ومتى تصير قابلة للإنفاق ولماذا لا تُنفق قبل ذلك، وعلامَ تُصرف وعلامَ لا تُصرف، وكيف تُحتسب مكافأة المراجعة وكيف يُقرَّر في هدية المراجعة، وكيف تعمل الإحالة وما هي محطاتها، وحق المتجر في عكس نقاط طلب أُلغي أو مراجعة مفتعلة.

### 1.2 الأطراف
المتجر: {{LEVONIS_LEGAL_NAME}}، المسجل برقم {{LEVONIS_REGISTRATION_NO}}، وعنوانه {{LEVONIS_ADDRESS}}، ويشار إليه بليفونيس. والزبون: صاحب الحساب المسجل في المنصة.
...
- البضاعة المؤهلة: قيمة المنتجات المباعة من متجر ليفونيس الرسمي، بالسعر المطبّق بعد خصومات المنتج والعضوية، دون أجرة توصيل ولا عمولة نقل ولا رسم ضمان ممتد.
...
### 4.1 أين تُصرف
تُصرف النقاط المستقرة خصماً من قيمة البضاعة المؤهلة عند إتمام طلب من متجر ليفونيس الرسمي.
...
ئەم بەڵگەنامەیە ڕوون دەکاتەوە چۆن خاڵی لێڤۆنیس بەدەست دەهێنرێت و بە چ ڕێژەیەک، کەی خەرجکردنی بۆ دەکرێت و بۆچی پێش ئەو کاتە خەرج ناکرێت، لەسەر چی خەرج دەکرێت و لەسەر چی خەرج ناکرێت، چۆن پاداشتی پێداچوونەوە دەژمێردرێت و چۆن بڕیار لەسەر دیاری پێداچوونەوە دەدرێت، ناردن چۆن کار دەکات و قۆناغەکانی چین، و مافی فرۆشگا بۆ گەڕاندنەوەی خاڵی داواکارییەکی هەڵوەشێنراوە یان پێداچوونەوەیەکی ساختە.

### 1.2 لایەنەکان
فرۆشگا: {{LEVONIS_LEGAL_NAME}}، تۆمارکراو بە ژمارە {{LEVONIS_REGISTRATION_NO}}، ناونیشانی {{LEVONIS_ADDRESS}}، کە بە لێڤۆنیس ئاماژەی پێ دەکرێت. کڕیار: خاوەنی ئەو هەژمارەیەی لە پلاتفۆرمەکەدا تۆمار کراوە.
...
- کاڵای شایستە: بەهای ئەو بەرهەمانەی لە فرۆشگای فەرمی لێڤۆنیسەوە دەفرۆشرێن، بە نرخی جێبەجێکراو دوای داشکاندنی بەرهەم و ئەندامێتی، بەبێ تێچووی گەیاندن و کۆمیسیۆنی گواستنەوە و باجی گەرەنتی درێژکراوە.
...
خاڵە جێگیرەکان وەک کەمکردنەوەیەک لە بەهای کاڵای شایستە خەرج دەکرێن لە کاتی تەواوکردنی داواکارییەک لە فرۆشگای فەرمی لێڤۆنیس.
