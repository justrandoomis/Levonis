...
هذه الوثيقة تبيّن متى يُقبل إرجاع منتج اشتُري من ليفونيس، وبأي شروط، ومن يتحمل كلفة الإرجاع، وماذا يحدث في كل حالة عملية يقع فيها الخلاف. النص العربي هو النص المعتمد، وما سواه ترجمة أمينة له بالترقيم نفسه.

### 4.1 التعريفات
- المتجر: {{LEVONIS_LEGAL_NAME}}، المشار إليه بـ ليفونيس.
...
- أجور التوصيل والضرائب المرافقة تحددها شركات التوصيل، لا ليفونيس. المتجر ينقل ما تطلبه الشركة ولا يزيد عليه ولا يتحكم فيه.
...
ئەم بەڵگەنامەیە ڕوون دەکاتەوە کەی بەرهەمێکی کڕدراو لە لێڤۆنیس دەگەڕێندرێتەوە، بە چ مەرجێک، کێ تێچووی گەڕاندنەوە هەڵدەگرێت، و لە هەر حاڵەتێکی کردەییدا کە ناکۆکی تێدا ڕوودەدات چی ڕوودەدات. دەقی عەرەبی دەقی پەسەندکراوە و ئەمە وەرگێڕانێکی دڵسۆزی ئەوە بە هەمان ژمارەبەندی.

### 4.1 پێناسەکان
- فرۆشگا: {{LEVONIS_LEGAL_NAME}}، کە بە لێڤۆنیس ئاماژەی پێدەکرێت.
...
- کرێ و باجی گەیاندن لەلایەن کۆمپانیاکانی گەیاندنەوە دیاری دەکرێن نەک لەلایەن لێڤۆنیسەوە. فرۆشگا ئەوە دەڵێت کە کۆمپانیاکە داوای دەکات، هیچی بۆ زیاد ناکات و کۆنترۆڵی ناکات.
