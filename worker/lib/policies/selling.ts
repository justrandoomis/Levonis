 ...
 *     languages. 24 transliterated occurrences left the body here — 12 in the
 *     Arabic body and 12 in the Sorani one. The Sorani half is why this line
...
تبيّن هذه الوثيقة ما يلتزم به المتجر تجاه الزبون، وحدود هذا الالتزام، وحقوق المتجر في رفض الطلب أو تقييده، والفرق بين البيع من متجر Levonis الرسمي والبيع عبر متاجر مجتمع ليفو.
...
### 1.3 التعريفات
- البائع: الطرف الذي تنشأ عليه التزامات البيع في طلب معيّن، وهو Levonis في طلبات المتجر الرسمي والتاجر في طلبات متاجر المجتمع.
...
- المنصة: نظام Levonis بكل خدماته، بما فيها مساحة مجتمع ليفو.
...
## 6. الفرق بين متجر Levonis الرسمي ومجتمع ليفو

### 6.1 متجر Levonis الرسمي
في المتجر الرسمي يكون Levonis هو البائع: البضاعة بضاعته، ومخزنه مصدرها، وهو المسؤول عن السعر والتجهيز والتوصيل والضمان والإرجاع وفق وثائقه.

### 6.2 مجتمع ليفو
في مجتمع ليفو يكون التاجر هو البائع، وتوفر المنصة العرض والسلة والطلب والدفع والمحادثة ونقل المال. ولا يصبح Levonis بائعاً للبضاعة لمجرد أنها عُرضت داخل منصته.
...
لا تجمع السلة بين بضاعة Levonis وبضاعة تاجر، ولا بين تاجرين، لأن لكل بائع طلبه وتسليمه وعمولته ومسؤوليته المستقلة.

### 6.5 الضمان والإرجاع في طلبات التجار
الضمان والإرجاع في طلبات متاجر المجتمع يقعان على التاجر وفق ما أعلنه في متجره، ما لم يكن المنتج مشمولاً بضمان مصنّع مستقل. ولا يلتزم Levonis بضمان بضاعة لم يبعها.
...
تدخّل المتجر في أي من الحالات أعلاه إجراء تنظيمي لحماية الزبون، ولا يجعل Levonis بائعاً ولا ضامناً لبضاعة التاجر.
...
أجرة التوصيل والضريبة المرتبطة بها تحددهما شركات التوصيل لا Levonis، والمتجر ينقل ما تفرضه الشركة ولا يتحكم به.
...
### 10.7 مسؤولية التاجر
مسؤولية التاجر عن بضاعته وعن وعوده قائمة تجاه زبونه، ولا تنتقل إلى Levonis بسبب استضافة المنصة للمعاملة.
...
ئەم بەڵگەنامەیە دیاری دەکات فرۆشگا چی لە بەرامبەر کڕیاردا لە ئەستۆ دەگرێت، سنووری ئەم پابەندییە، مافی فرۆشگا لە ڕەتکردنەوە یان سنووردارکردنی داواکاری، و جیاوازی نێوان فرۆشتن لە فرۆشگا فەرمییەکەی Levonis و فرۆشتن لە ڕێگەی فرۆشگاکانی کۆمەڵگای لیڤۆوە.
...
### 1.3 پێناسەکان
- فرۆشیار: ئەو لایەنەی پابەندی فرۆشتن لە داواکارییەکی دیاریکراودا لەسەری دەکەوێت، Levonisە لە داواکارییەکانی فرۆشگا فەرمییەکە و بازرگانە لە داواکارییەکانی فرۆشگاکانی کۆمەڵگا.
...
- پلاتفۆرم: سیستەمی Levonis بە هەموو خزمەتگوزارییەکانییەوە، بە بۆشایی کۆمەڵگای لیڤۆشەوە.
...
## 6. فرۆشگا فەرمییەکەی Levonis و کۆمەڵگای لیڤۆ

### 6.1 فرۆشگا فەرمییەکەی Levonis
لە فرۆشگا فەرمییەکەدا Levonis فرۆشیارە: کاڵاکە هی خۆیەتی، کۆگاکەی سەرچاوەیەتی، و بەرپرسیارە لە نرخ و ئامادەکاری و گەیاندن و گەرەنتی و گەڕاندنەوە بەپێی بەڵگەنامەکانی خۆی.

### 6.2 کۆمەڵگای لیڤۆ
لە کۆمەڵگای لیڤۆدا بازرگان فرۆشیارە، و پلاتفۆرم پیشاندان و سەبەتە و داواکاری و پارەدان و گفتوگۆ و گواستنەوەی پارە دابین دەکات. Levonis تەنها لەبەر ئەوەی کاڵاکە لە ناو پلاتفۆرمەکەیدا پیشان دراوە نابێتە فرۆشیاری.
...
سەبەتە کاڵای Levonis و کاڵای بازرگان کۆناکاتەوە، نە دوو بازرگانیش، چونکە هەر فرۆشیارێک داواکاری و گەیاندن و کۆمیسیۆن و بەرپرسیاریەتی سەربەخۆی خۆی هەیە.

### 6.5 گەرەنتی و گەڕاندنەوە لە داواکارییەکانی بازرگاناندا
گەرەنتی و گەڕاندنەوە لە داواکارییەکانی فرۆشگاکانی کۆمەڵگادا لەسەر بازرگانن بەپێی ئەوەی لە فرۆشگاکەیدا ڕایگەیاندووە، مەگەر بەرهەمەکە بە گەرەنتی بەرهەمهێنەرێکی سەربەخۆ داپۆشرابێت. Levonis پابەند نییە بە گەرەنتیکردنی کاڵایەک کە خۆی نەیفرۆشتووە.
...
دەستێوەردانی فرۆشگا لە هەر یەکێک لە حاڵەتەکانی سەرەوەدا ڕێکارێکی ڕێکخستنەییە بۆ پاراستنی کڕیار، و Levonis ناکاتە فرۆشیار یان دەستەبەرکەری کاڵای بازرگان.
...
کرێی گەیاندن و ئەو باجەی پێوەی بەستراوە لەلایەن کۆمپانیاکانی گەیاندنەوە دیاری دەکرێن نەک لەلایەن Levonisەوە، و فرۆشگا ئەوە دەگوازێتەوە کە کۆمپانیاکە داوای دەکات و کۆنترۆڵی ناکات.
...
بەرپرسیاریەتی بازرگان لەسەر کاڵا و بەڵێنەکانی بەرامبەر کڕیارەکەی دەمێنێتەوە، و بەهۆی میوانداریکردنی مامەڵەکە لەلایەن پلاتفۆرمەوە بۆ Levonis ناگوازرێتەوە.
