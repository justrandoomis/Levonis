 ...
 *   * THE UNKNOWNS. 1 article and 12 further lines in this document still state a
 ...
 *   * THE FACTS. worker/lib/policies/facts.ts now states `LEVONIS_SUPPORT_CONTACT`,
...
هذه الوثيقة تبيّن ما يقدمه Levonis بعد التسليم: ما هو مجاني، وما هو مدفوع، وبأي قنوات، وفي أي أوقات، وما هو خارج الخدمة أصلًا. النص العربي هو النص المعتمد.

### 7.1 نطاق الوثيقة
- تسري هذه الوثيقة على الأجهزة والمنتجات المشتراة من المتجر الرسمي لـ Levonis.
...
- صيانة أو تشخيص جهاز لم يُشترَ من Levonis، ولو كان من الصنف نفسه.
...
- خدمات التصميم والطباعة التي يبيعها Levonis خدمات مستقلة لها شروطها وأسعارها، ولا تُقدَّم مجانًا بوصفها دعمًا.
...
ئەم بەڵگەنامەیە ڕوون دەکاتەوە کە Levonis دوای گەیاندن چی پێشکەش دەکات: چی بێبەرامبەرە، چی پارەی لەسەرە، بە چ کەناڵێک، لە چ کاتێکدا، و چی لە بنەڕەتدا لە دەرەوەی خزمەتگوزارییەکەیە. دەقی عەرەبی دەقی پەسەندکراوە.

### 7.1 بوارى ئەم بەڵگەنامەیە
- ئەم بەڵگەنامەیە لەسەر ئەو ئامێر و بەرهەمانە جێبەجێ دەبێت کە لە فرۆشگای فەرمی Levonis کڕدراون.
...
- چاکسازی یان دەستنیشانکردنی ئامێرێک کە لە Levonis نەکڕدراوە، تەنانەت ئەگەر هەمان مۆدێل بێت.
...
- ئەو خزمەتگوزارییانەی دیزاین و چاپ کە Levonis دەیانفرۆشێت خزمەتگوزاری سەربەخۆن و مەرج و نرخی خۆیان هەیە، و وەک پشتگیری بە بێبەرامبەر پێشکەش ناکرێن.
