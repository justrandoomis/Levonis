 ...
 *   * THE UNKNOWNS. 16 articles and 16 further lines in this document still state a
...
تبيّن هذه الوثيقة من يجوز له فتح حساب على منصة Levonis، وما يلتزم به صاحب الحساب، وكيف تُثبت ملكية البريد أو رقم الهاتف ولماذا يصرّ المتجر على إثباتها، وكيف تُحفظ بيانات الدخول ومن يتحمل الخسارة عند إفشائها، وما يوقف الحساب أو يغلقه، وكيف يغلق الزبون حسابه، وما يبقى عند المتجر بعد الإغلاق وإلى متى.
...
تُحجز أسماء المستخدمين التي تدل على المنصة أو على موظفيها أو على أقسام الموقع، مثل ما يشير إلى Levonis أو الدعم أو الإدارة أو المحفظة أو الطلبات. لأن رسالة من اسم كهذا تُقرأ على أنها من المتجر.
...
ئەو ناوانەی ئاماژە بە پلاتفۆرم یان بە کارمەندەکانی یان بە بەشەکانی ماڵپەڕەکە دەکەن پاراستراون — وەک هەر ئەوەی ئاماژە بە Levonis یان پشتگیری یان بەڕێوەبەرایەتی یان جزدان یان داواکارییەکان دەکات. چونکە پەیامێک لە ناوێکی وا وەک پەیامێک لە فرۆشگاوە دەخوێندرێتەوە.
