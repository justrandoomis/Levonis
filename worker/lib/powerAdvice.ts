...
export function advise(input: PowerInput): PowerAdvice {
  ...
  const topologyPoints: PowerPoint[] = [
    ...
    },
    {
      ...
      text: {
        ar: 'لذلك توصية Levonis للطابعة ثلاثية الأبعاد: UPS أونلاين. الأوفلاين ينفع للراوتر والكومبيوتر، أما الطبعة الطويلة فما تتحمل فجوة التحويل ولا تذبذب كهرباء العراق.',
        ...
        ckb: 'بۆیە Levonis بۆ پرینتەری سێ ڕەهەندی UPSی ئۆنلاین پێشنیار دەکات. لاین‑ئینتەراکتیڤ بۆ ڕاوتەر و کۆمپیوتەر باشە، بەڵام چاپی درێژ نە کەلێنی گواستنەوە نە شڵەژانی کارەبای عێراق هەڵناگرێت.',
      },
    },
  ];
