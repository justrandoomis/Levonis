 ...
 * the same adapter `tests/fixtures/d1.ts` gives the core's tests, kept inside
 * the package so its tests never import the core. Real constraints, real
 * UNIQUE indexes, real "0 rows updated aborts the dependent writes".
 */
