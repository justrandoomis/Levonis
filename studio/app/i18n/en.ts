...
export const en = {
  ...
  realEditorHelp: "Move, rotate, scale, delete, duplicate, split, undo/redo, multi-plate editing, general auto-arrange with undo, and 3MF save.",
  missingTools: "Current engine limits",
  missingToolsHelp: "Up to 9 plates on a rectangular bed. Auto Orient, Cut, Boolean and 3D text are not implemented by the engine and are not simulated.",
