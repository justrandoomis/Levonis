...
* أعمدة `membership.*`: سقف بلا `cap_scope` يُرفض، و`cap_scope` بلا سقف يُرفض،
  ...
  بالدينار محدودة بـ ١٬٠٠٠٬٠٠٠٬٠٠٠ و`max_quantity` بـ ٩٩٩٩ — وهي حرفيًا رفوضات
  لوحة الإدارة نفسها وبحدودها نفسها (§١١)، مربوطة بها باختبار يسوق البابين بالقيمة
  ذاتها عند الحد.
...
| `membership.<الفئة>.fixed_iqd` | عدد صحيح ٠..١٬٠٠٠٬٠٠٠٬٠٠٠ | د.ع |
| `membership.<الفئة>.max_discount_iqd` | عدد صحيح ٠..١٬٠٠٠٬٠٠٠٬٠٠٠ (سقف الخصم) | د.ع |
| `membership.<الفئة>.cap_scope` | `per_unit` / `per_order` / `__NULL__` | — |
| `membership.<الفئة>.max_quantity` | عدد صحيح ١..٩٩٩٩ | قطعة |
...
* **`discount_mode=__NULL__`** → تُحذف **كل** قواعد المنتج لهذه الفئة، كلٌّ بكتابة
  مسجَّلة ومدقَّقة مستقلّة. اللوحة لا تمنع وجود تجاوزين لفئة واحدة، وحذف الغالب
  وحده كان سيترك الآخر يسعّر كل طلب بينما الملف والمعاينة والتصدير التالي تقول
  جميعها إن التجاوز رُفع.
