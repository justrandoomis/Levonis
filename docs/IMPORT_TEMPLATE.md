...
- لا يُرفَع الأساسي تلقائيًا، ولا يُخفَض تحت سعر PRO/PRIME للمنتج ولا على
  كلفته (يُكتب تحذير بدل ذلك). لون بسعر ثابت على منتج تختلف خياراته سعرًا
  يبقى ثابتًا مع تعليق يقول لماذا.
