 ...
 * charcoal square (a cream chip on the light theme) — the only gold on the page below the hero, where the
  ...
  return (
    ...
    >
      {/* The finder's wand on its own tile: charcoal and gold on the dark
          ...
          one (`data-feature` + `lv-feature-chip`, src/index.css). */}
      <span data-feature="" aria-hidden="true" className="lv-feature-chip grid size-11 shrink-0 place-items-center rounded-xl bg-charcoal text-gold-muted lg:size-14">
