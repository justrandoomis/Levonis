...
const AR: PolicyStrings = {
  ...
  libraryIntro:
    'النصوص الرسمية التي تحكم الشراء والدفع والتوصيل والضمان والاسترجاع في ليفونيس. كل وثيقة تحمل رقم نسختها وتاريخ سريانها، وكل مادة فيها لها رابط مستقل يمكن إرساله.',
  governing:
...
const CKB: PolicyStrings = {
  ...
  libraryIntro:
    'دەقە فەرمییەکانی کڕین و پارەدان و گەیاندن و گەرەنتی و گەڕاندنەوە لە لێڤۆنیس. هەر بەڵگەنامەیەک ژمارەی وەشان و بەرواری جێبەجێبوونی هەڵدەگرێت، و هەر بڕگەیەکی بەستەرێکی سەربەخۆی هەیە کە دەنێردرێت.',
  governing:
