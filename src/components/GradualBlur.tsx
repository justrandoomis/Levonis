...
const DEFAULT_CONFIG = {
  ...
  divCount: 5,
  exponential: false,
  zIndex: 40, // Since BottomNav is z-50, this should be below it but above content
  animated: false,
  duration: '0.3s',
  easing: 'ease-out',
  opacity: 1,
...
const PRESETS = {
  ...
  bottom: { position: 'bottom', height: '10rem', strength: 3, divCount: 8, exponential: true, curve: 'ease-out' },
