  ...
  return (
    <div className="w-full bg-black min-h-screen font-sans flex flex-col text-white pb-24 overflow-y-auto relative">
      ...
      <div className="flex items-center px-4 py-4 sticky top-0 z-10 relative">
        ...
        {isPro ? (
          <span className="p-1 px-3 text-[12px] font-bold rounded-full bg-gold text-[#0A1F18]">PRO</span>
        ) : (
      ...
      <div className="px-5 relative z-10 mt-2">
        {authLoaded && !isAuthenticated ? (
          <div className="text-center py-20">
            <Star className="w-10 h-10 mx-auto mb-3 text-gold/40" />
            <p className="text-white/60 font-medium mb-4">Sign in to earn and track your points</p>
            <button onClick={() => navigate('/auth')} className="px-6 py-2.5 bg-gold text-[#0A1F18] rounded-full font-bold text-sm">
              Sign in
            </button>
          </div>
        ) : (
        ...
        <div className="flex justify-between items-center mb-8 relative">
          <div className="pt-2">
            ...
            <div className="text-[56px] leading-[1.1] font-black tracking-tight">{(data?.point_balance ?? pointBalance).toLocaleString()}</div>
          </div>
          ...
          <div className="bg-[#0A1F18] rounded-[24px] p-4 shadow-[0_8px_30px_rgba(0,0,0,0.06)] relative z-10">
            ...
            <div className="pl-3">
              ...
              <button
                ...
                ${isCheckedInToday || !data ? 'bg-[#0F2F25] text-white/40' : 'bg-gold text-[#0A1F18]'}`}>
        ...
        <div className="mt-8 mb-8">
          ...
          <div className="space-y-3 px-1">
            ...
            {allDailyDone && <div className="text-white/40 text-center py-4 text-sm">You're all caught up for today!</div>}
            ...
            <div className={`bg-[#0F2F25] rounded-[20px] p-4 flex items-center justify-between shadow-sm transition-colors ${missions.video.available ? 'cursor-pointer hover:bg-[#184235]' : 'opacity-60'}`}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-white/40 font-medium text-[12px]">
