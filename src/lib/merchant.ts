...
// The four values a store VISITOR needs live in ./storefrontApi (W6), so the
// storefront's closure carries them without this whole module (the merchant,
// order, checkout and admin clients). Re-exported: every import of them from
// here keeps working.
export { storefrontApi, communityFavoritesApi, iqd, badgeLabel } from './storefrontApi';
